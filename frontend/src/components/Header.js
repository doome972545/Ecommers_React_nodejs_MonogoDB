                ...
                <div className="flex items-center gap-4 md:gap-7">
                    ...
                    <div className=" text-slate-600"onClick={handleShowMenu} >
                        ...
                        </div>
                        {
                            ...
                            <Link to={"newproduct"}><p className="whitespace-nowrap cursor-pointer">New Product</p></Link>
                            <Link to={"login"}><p className="whitespace-nowrap cursor-pointer">Login</p></Link>
                        </div>
                        )}
